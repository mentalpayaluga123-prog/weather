...
private val DarkColorScheme = darkColorScheme(
    ...
    onPrimaryContainer = AtmosphericBlue,
    secondary = AtmosphericBlue,
...
private val LightColorScheme = lightColorScheme(
    ...
    primaryContainer = AtmosphericBlue,
...
fun WeatherSphereTheme(
    darkTheme: Boolean = true, // Default to futuristic dark atmospheric theme
